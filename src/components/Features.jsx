        ...
        <div className="container mx-auto px-3 md:px-10">
            ...
            <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
                <BentoCard 
                    ...
                    description="A cross-platform metagame app, turning your activities into a exciting adventure."
                />
            </BentoTilt>
            ...
            <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
                    <BentoCard 
                        ...
                        title={<>zig<b>m</b>a</>}
                        description="An anima and gaming inspired collection - the immersive world primed for exploration."
                    />
                </BentoTilt>

                <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-1">
                    <BentoCard 
